 ...
 * PSRAM_HEAP:如果需要用到psram,需要打开PSRAM_HEAP
 ********************************************************************/
#define DEFAULT_SYS_CLK                (240*1000000) //(192*1000000) 
#define PSRAM_HEAP          //如果需要psram当作heap,需要打开这个宏
#define AV_PSRAM_HEAP    
#define AV_HEAP
...
*********************************************************************************************************************************************/
#define CONFIG_PSRAM_AVHEAP_SIZE        (3*1024*1024+512*1024)
 ...
 *********************************************************************************************************************************************/
#define CONFIG_AVHEAP_SIZE              (140*1024)
...
#define LCD_ST7701S_MIPI_EN             0
#define LCD_ST7789T3_SPI_EN             1

#define KEY_MODULE_EN                   1


#if (LCD_ST7789T3_SPI_EN ==1)

#if 0
#define PIN_LCD_RESET  PB_11 //lcd_res
#define DOTCLK_RWR PB_12    // spi_scl
#define DE_ERD 255          
#define VS_CS  PB_13        // spi_cs
#define HS_DC  PB_9         // spi_dc
#define LCD_TE 255          // lcd_te

#define LCD_D0 PB_10        // spi_sda
#else

#define PIN_LCD_RESET  PA_7 //lcd_res
#define DOTCLK_RWR PA_15    // spi_scl
#define DE_ERD 255          
#define VS_CS  PA_6        // spi_cs
#define HS_DC  PA_9         // spi_dc
#define LCD_TE 255          // lcd_te

#define LCD_D0 PA_10        // spi_sda
#endif
#define LCD_D1 255
#define LCD_D2 255
#define LCD_D3 255
